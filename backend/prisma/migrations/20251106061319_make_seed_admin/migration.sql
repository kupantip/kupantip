...
CREATE TABLE [dbo].[app_user] (
    ...
    CONSTRAINT [PK__app_user__3213E83FC82FB4AF] PRIMARY KEY CLUSTERED ([id]),
    CONSTRAINT [UQ__app_user__AB6E61641C100918] UNIQUE NONCLUSTERED ([email]),
    CONSTRAINT [UQ__app_user__7ED567C02725D883] UNIQUE NONCLUSTERED ([handle])
);
...
CREATE TABLE [dbo].[attachment] (
    ...
    CONSTRAINT [PK__attachme__3213E83FF060078B] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[category] (
    ...
    [color_hex] VARCHAR(7),
    CONSTRAINT [PK__category__3213E83F84440C4D] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[comment] (
    ...
    [deleted_at] DATETIME,
    CONSTRAINT [PK__comment__3213E83FF74471FB] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[comment_vote] (
    ...
    CONSTRAINT [PK__comment___0C0E95F7CB1F91BD] PRIMARY KEY CLUSTERED ([comment_id],[user_id])
);
...
CREATE TABLE [dbo].[post] (
    ...
    CONSTRAINT [PK__post__3213E83FC621AFCE] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[post_vote] (
    ...
    CONSTRAINT [PK__post_vot__D54C64165658456C] PRIMARY KEY CLUSTERED ([post_id],[user_id])
);
...
CREATE TABLE [dbo].[report] (
    ...
    CONSTRAINT [PK__report__3213E83F9893DB22] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[user_role] (
    ...
    CONSTRAINT [PK__user_rol__31DDE51B735CAF6C] PRIMARY KEY CLUSTERED ([user_id],[role])
);
...
CREATE TABLE [dbo].[user_secret] (
    ...
    CONSTRAINT [PK__user_sec__B9BE370F1DC66A08] PRIMARY KEY CLUSTERED ([user_id])
);
...
CREATE TABLE [dbo].[moderation_action] (
    ...
    CONSTRAINT [PK__moderati__3213E83F16C9F4CE] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[user_ban] (
    ...
    CONSTRAINT [PK__user_ban__3213E83F4C275822] PRIMARY KEY CLUSTERED ([id])
);
