...
import { createPost } from "../../../services/user/create-post";
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <select
            ...
            className="border border-gray-300 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-emerald-700 cursor-pointer"
          >
          ...
          <div className="flex justify-end">
            <Button
              type="submit"
              disabled={loading}
              className="bg-emerald-700 hover:bg-emerald-800 text-white rounded-full px-8 py-2 transition shadow-sm cursor-pointer"
            >
