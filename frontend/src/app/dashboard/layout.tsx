				...
				<div className="flex justify-between items-center w-screen">
					...
					<div className="flex flex-wrap items-center gap-x-3">
						...
						<Link href="/dashboard/create-post">
							<Button className="group w-20 bg-transparent text-white rounded-lg hover:bg-transparent flex items-center gap-2 cursor-pointer">
						...
						<Link href="/login">
							<Button className="w-30 bg-green-1 text-white rounded-lg hover:bg-green-700 cursor-pointer">
								<div className="hover:underline">Log In</div>
							</Button>
						</Link>
						<Button
							variant="ghost"
							className="p-0 bg-transparent hover:bg-transparent focus-visible:ring-0 cursor-pointer"
						>
